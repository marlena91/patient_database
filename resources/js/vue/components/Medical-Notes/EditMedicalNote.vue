        ...
        <form @submit.prevent="update">
             <div class="form-row mb-4">
                <div class="form-group col-md-6 mt-3">
                    <input type="text" v-model="medicalNote.title" class="form-control form-control-sm" placeholder="Tytuł dokumentacji...">
                </div>
                <div class="form-group col-md-6 mt-3">
                    <textarea type="text" rows="5" cols="33" v-model="medicalNote.description" class="form-control form-control-sm" autofocus></textarea>
                </div>
            </div>
